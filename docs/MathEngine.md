...
| `exerciseMemory.js` | Anti-repetition. Fingerprints served problems (concept/structure/context/answer), scores candidate novelty against a per-user memory, and picks the freshest. |
