...
// NOTE: server.js is now just bootstrap + the NRS rating routes + Socket.IO duel logic;
// all REST domains live under routes/* and their helpers under services/* and lib/*.
