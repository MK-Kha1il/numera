...
const RICH_STRANDS = new Set(['integers', 'decimals', 'fractions', 'geometry', 'number_sense', 'statistics', 'expressions', 'powers', 'graphing', 'inequalities', 'functions', 'sequences', 'equations', 'rates', 'factors']);
